...
The higher `elpd_diff` value of m2 confirms that model m2 (including the interaction effect) fits the data better than the standard model without the interaction effect. Consequently, we will only move forward with m2.
