...
```{r posterior-check-plot include = FALSE}
ggsave( 'figures/bda-posterior-check.pdf', height = 20,  units = "cm" )
```
...
```
```{r conditional-plots-export include = FALSE}
suppressPackageStartupMessages(library(tikzDevice))

tikz("figures/bda-conditional-treatment.tex", width = 6, height = 4)
conditional.effect.treatment
dev.off()

tikz("figures/bda-conditional-learing.tex", width = 6, height = 4)
