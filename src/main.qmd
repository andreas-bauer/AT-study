...
legend("topleft", fill = c("palevioletred", "#69b3a2"),
...
#| output: false
suppressPackageStartupMessages(library(tikzDevice))
tikz("time_per_subject.tex", width = 6, height = 4)
...
Violin plot of time per test case (both treatments)
```{r}
#| output: false
tikz("time_per_tc_split.tex", width = 6.5, height = 3)
par(mar = c(2, 4, 1, 1)) # Set the margin
vioplot(df_only_m,
        side = "left",
        col = "palevioletred",
