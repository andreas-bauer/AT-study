...
dfSplitMean <- dfSplitMean %>%
  mutate(
     TC1_diff = 100 / TC1_M * (TC1_A - TC1_M),
     TC2_diff = 100 / TC2_M * (TC2_A - TC2_M),
     TC3_diff = 100 / TC3_M * (TC3_A - TC3_M),
     TC4_diff = 100 / TC4_M * (TC4_A - TC4_M),
     TC5_diff = 100 / TC5_M * (TC5_A - TC5_M),
     TC6_diff = 100 / TC6_M * (TC6_A - TC6_M),
     TC7_diff = 100 / TC7_M * (TC7_A - TC7_M),
     TC8_diff = 100 / TC8_M * (TC8_A - TC8_M)
  ) %>%
  ...
  mutate(
    sum_diff = round(100 / M_sum * (A_sum - M_sum), 0)
  )
